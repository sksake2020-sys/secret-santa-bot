# webhook_app.py - ПОЛНАЯ ИСПРАВЛЕННАЯ ВЕРСИЯ
...
/startgame - начать игру
    ...
    async def handle_new_game(message: types.Message):
        ...
        pending_new_game[message.from_user.id] = True  # ставим флаг
        await worker_bot.send_message(
            chat_id=message.chat.id,
    ...
    async def handle_all_messages(message: types.Message):
        ...
        # Если пользователь вводит название новой игры (флаг поставлен командой /newgame)
